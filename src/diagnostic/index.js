...
const analysis = phrase => {
  ...
  */
  ...
  if(worddiag.length > 0){
    ...
    message += "A normal computer could crack it in " + convertMS(Math.exp(wordTotal + nonwordTotal - 16))
  } else {
  	nonwordTotal = nonwordRawTotal
  	message += 'Your password is a sequence of purely non-alphabetical characters\n'
    message += "A normal computer could crack it in " + convertMS(Math.exp(nonwordTotal - 16))
  }
  return message
}
